...
function renderQrCode(shorLinkURL, deepLinkURL, androidData, iosData, otherPlatformsLink, options) {
    ...
    export class ZeroPassPortWidget extends React.Component{
        state = { 
            ...
            shortLinkURL: "null", // <url>
            deepLinkURL: "null", // <url>
            linkOtherPlatforms: "null", // <url>
            config: {} //config = {userID: "userID", requestType: "<type>", url: "<url>", version: <version>};
        }


        constructor(props) {
            super(props);
             this.state.androidData = this.props.androidData;
             this.state.iosData = this.props.iosData;
             this.state.shortLinkURL = this.props.shortLinkURL;
             this.state.deepLinkURL = this.props.deepLinkURL;
             this.state.linkOtherPlatforms = this.props.linkOtherPlatforms;
             this.state.config = this.props.config;
             this.state.config.app = "port.app"; //add constant parameter

             this.state.CALLBACK_EXIT_BUTTON = this.props.callbackFunction;
          }

            componentDidMount(){
                //it should be excuted only once
                if (this.first) return; this.first = true;

                createWidget(this.state.shortLinkURL, this.state.deepLinkURL, this.state.androidData, this.state.iosData, this.state.linkOtherPlatforms, this.state.config);
            }
            ...
            closeButtonPressed = () => {
                this.state.CALLBACK_EXIT_BUTTON();
            }
    
            render(){
                return (<>
                    <div
                        data-w-id="ab4e72fd-54b3-defa-783f-a5abc41f4420"
                        style={{ opacity: 1.0 }}
                        className="divbackgroundblackpl"
                    >
                        <div
                        data-w-id="55797719-95b5-9f3e-d991-33150963fb19"
                        style={{ opacity: 1.0 }}
                        className="divwindowpl"
                        >
                        <div className="div1portpl">
                            <div className="div1apl" />
                            <div className="div1apl">
                            <div style={{ marginTop: 30, width: 60 }}>
                                ...
                                x="0px"
                                y="0px"
                                viewBox="0 0 243.98 174"
                                style={{ enableBackground: "new 0 0 243.98 174" }}
                                xmlSpace="preserve"
                                >
                                <style
                                    type="text/css"
                                ...
                                <path
                                    className="st0"
                                    d="M233.84,38.21l-68.22,12.98c-19.54-23.98-54.81-27.59-78.79-8.05c-10.19,8.3-17.15,19.95-19.63,32.87H1.16 
                        C4.15,46.2,17.86,19.55,38.4,0h168.34C218.07,10.8,227.33,23.75,233.84,38.21z"
                                />
                                <path
                                    className="st1"
                                    d="M233.9,138.21v0.15c-5.98,13.33-14.3,25.39-24.44,35.64H35.67C16.06,154.13,3.24,127.55,0.92,98.01h66.44 
                        c6.32,30.27,35.98,49.69,66.25,43.39c11.34-2.38,21.66-8.18,29.55-16.66L233.9,138.21z"
                                ...
                                <linearGradient
                                    ...
                                    x2="96.3439"
                                    y2="921.0519"
                                    gradientTransform="matrix(1 0 0 1 -12 -833.3666)"
                                >
                                    <stop offset={0} style={{ stopColor: "#B2876F" }} />
                                    <stop offset={1} style={{ stopColor: "#896954" }} />
                                </linearGradient>
                                <path
                                    className="st2"
                                    d="M243.82,89.93l-5.76,30.19c-0.28,0.65-0.97,1.03-1.66,0.89l-81.74-15c-10.12,18.1-32.99,24.57-51.09,14.45 
                        ...
                        l5.76,30.19C244.03,88.59,244.03,89.28,243.82,89.93z"
                            ...
                            <div className="div1xpl">
                            <a href={void(0)} onClick={this.closeButtonPressed}
                                className="linkblockxpl w-inline-block">
                                <div style={{ width: 16, marginRight: 24 }}>
                                <div className="xmouseover2pl">
                                    <svg
                                    version="1.1"
                                    id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g>
                                        <path
                                        className="st01"
                                        d="M504.8,45.4l-35.4-35c-9.6-9.6-25.4-9.6-35.4,0L257.6,186.9L77.8,7.1c-9.6-9.6-25.4-9.6-35.4,0L7.1,42.5 
                        ...
                        <div>
                            <div className="text1portpl">Attest</div>
                            <div className="text2portpl">
                            Scan the QR code with Port app, or press the button if the Port app is
                            on the same device.
                            </div>
                        </div>
                        <div className="divqrpl">
                            <section id="qr-code" />
                        </div>
                        <div className="div-buttonpl">
                            <div className="textlink1pl">
                            <a href={void(0)} onClick={this.copyClipboard} className="link-2">
                                copy magnet link
                            </a>
                            </div>
                            <a href={void(0)} onClick={this.openDeepLink} className="buttonpl w-button">
                            Launch Port
                            </a>
                        </div>
                        <div className="divdownloadpl">
                            <div className="textlink2pl">
                            <a href="https://port.link" className="linkpl">
                    ...
                    <script
                        src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=60a5ad862f20836237dc00cc"
                        type="text/javascript"
                        integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0="
                        crossOrigin="anonymous"
                    >
                        &lt;\\/script&gt; &lt; script src = "js/webflow.js" type = "text/javascript"
